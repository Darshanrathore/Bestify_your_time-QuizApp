...
@Component({
  selector: 'app-viewquiztype',
  templateUrl: './viewquiztype.component.html',
  styleUrls: ['./viewquiztype.component.scss']
})
export class ViewquiztypeComponent implements OnInit {
  ...
  constructor(private router:Router,private quizservice:QuizService, private activeroute:ActivatedRoute) {
   ...
   viewQuiz(catId:any){
    this.router.navigate(['../view-quiz/'+catId], {relativeTo: this.activeroute});
   }
